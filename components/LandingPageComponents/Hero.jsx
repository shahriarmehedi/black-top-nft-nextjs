...
export default function Hero() {
    ...
    return (
        ...
        <div className="bg-[url('/img/gradient.png')] h-[750px] bg-cover bg-center bg-no-repeat">
            ...
            <div className=' container mx-auto  bg-[#3AC5A6] h--[700px] lg:h-[550px] rounded-2xl flex flex-col lg:flex-row items-center justify-between'>
                <div className='lg:pl-14 w-5/6 lg:w-full pt-5 lg:pt-0'>
